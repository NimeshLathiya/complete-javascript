...
console.log(myName + " nimesh ");
console.log(myName + " lathiya ");
console.log(myName + " nl ");
...
console.log(Data);
const change = { ...Data, myAge: 23 };
console.log(change);

//{ myFname: 'nimesh', myLname: ';lathiya', myAge: 23 }
//{ myFname: 'nimesh', myLname: 'lathiya', myAge: 23 }
...
console.log(myBio);
//{ '26': 'is my age', nimesh: 'hello how are you?' }
...
const message = "my name is nimesh";
console.log(message);
...
var myFriends = ["nimesh", "ramesh", "arjun", "vishal", 5, 5];
...
var myFriends = ["nimesh", "ramesh", "arjun", "vishal"];
...
// milan index : 0 nimesh,ramesh,arjun,vishal
// ramesh index : 1 nimesh,ramesh,arjun,vishal
// arjun index : 2 nimesh,ramesh,arjun,vishal
// vishal index : 3 nimesh,ramesh,arjun,vishal

//!searching and filter
//!search
var myFriendNames = ["nimesh", "nl", "lathiya", "lathiyatechnical", "lathiya"];

console.log(myFriendNames.indexOf("nl"));
//1

var myFriendNames = ["nimesh", "nl", "lathiya", "lathiyatechnical", "lathiya"];

console.log(myFriendNames.lastIndexOf("lathiya"));
//4

var myFriendNames = ["nimesh", "nl", "lathiya", "lathiyatechnical"];

console.log(myFriendNames.includes("lathiya"));
//true
...
let sData = mybiodata.search("nimesh");
console.log(sData);
//9
...
let myBiodata = `I am nimesh nl lathiya nimesh`;

let repalceData = myBiodata.replace("nimesh", "lathiya");
console.log(repalceData);
console.log(myBiodata);

// I am lathiya nl lathiya nimesh
// I am nimesh mk lathiya nimesh
